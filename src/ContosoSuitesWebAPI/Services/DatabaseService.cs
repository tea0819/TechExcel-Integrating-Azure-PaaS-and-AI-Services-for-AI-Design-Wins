...
public class DatabaseService : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the Hotel and Date")] int hotelId, DateTime dt)
    {
       ...
       [KernelFunction]
       [Description("Get Bookings by Missing Hotel Rooms")]
